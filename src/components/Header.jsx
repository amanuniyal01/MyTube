  ...
  return (
    <div className="flex justify-between items-center shadow-md px-4 py-2 bg-white">
      ...
      <div className="flex items-center w-1/2">
        <input
          className="  md:flex-grow md:border md:border-gray-300 md:rounded-l-full md:px-4 md:py-2  md:outline-none md:text-gray-800"
          type="text"
          placeholder="Search"
        />
        ...
        <button className="ml-3 p-2 bg-gray-100 rounded-full hover:bg-gray-200">
          <Mic className="md:h-5 md:w-5 hidden" />
        </button>
      </div>

      {/* Right Section: Notification + User */}
      <div className="flex items-center gap-4">
        <Bell className="md:h-6 md:w-6 md:cursor-pointer hidden" />
        <img
